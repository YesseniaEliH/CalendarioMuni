    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:#DFC728">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./" style="color:#160E0E">AGENSIS <img class="logo-image" src="img/pasco.gif" style="height:35px;" /><small> HMPP</small></a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          ...
          <li><a href="index.php?view=projects"><i class="fa fa-flask"></i> Oficinas</a></li>
